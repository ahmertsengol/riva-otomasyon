...
urlpatterns = [
    ...
    path("protokol-secenekleri/", views.definition_options, name="definition_options"),
    path("kayit/<int:pk>/", views.VaccineRecordDetailView.as_view(), name="record_detail"),
    path("kayit/<int:pk>/duzenle/", views.VaccineRecordUpdateView.as_view(), name="record_update"),
    path("kayit/<int:pk>/sil/", views.VaccineRecordDeleteView.as_view(), name="record_delete"),
